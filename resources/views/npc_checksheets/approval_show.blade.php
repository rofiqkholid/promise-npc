...
<div class="bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 max-w-5xl mx-auto">
    ...
    <form action="{{ route('checksheet-approvals.store', $checksheet->hashed_id) }}" method="POST">
        ...
        <div class="px-6 py-4 bg-gray-50 dark:bg-gray-800/80 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
            ...
            <button type="submit" name="action" value="reject" class="px-5 py-2 bg-red-600 hover:bg-red-700 text-white transition shadow-sm font-semibold flex items-center gap-2 text-sm" onclick="return confirm('Are you sure you want to reject and return to the previous level?');">
                <i class="fa-solid fa-rotate-left"></i> Reject
            </button>
            <button type="submit" name="action" value="approve" class="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white transition shadow-sm font-semibold flex items-center gap-2 text-sm">
