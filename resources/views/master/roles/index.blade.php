...
<div class="bg-white dark:bg-gray-800 shadow border border-gray-200 dark:border-gray-700">
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
        ...
        <a href="{{ route('master.roles.create') }}" class="px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-600 text-white hover:from-blue-700 hover:to-cyan-700 transition shadow-md shadow-blue-500/20 font-medium text-sm flex items-center gap-2">
            ...
            <table id="rolesTable" class="w-full text-sm text-left text-slate-600 dark:text-slate-400">
                <thead class="bg-gray-100 dark:bg-gray-700/50 text-slate-800 dark:text-slate-200 border-b border-gray-200 dark:border-gray-600 uppercase text-xs tracking-wider">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 font-semibold">Users</th>
    ...
    $(document).ready(function() {
        initPromiseDataTable('#rolesTable', {
            ...
            columns: [
                ...
                { data: 'code', name: 'code', className: 'px-6 py-4 font-mono' },
                { data: 'description', name: 'description', className: 'px-6 py-4 text-slate-500 dark:text-slate-400', orderable: false, searchable: false },
                { data: 'users_count', name: 'users_count', className: 'px-6 py-4', orderable: false, searchable: false },
