...
<body class="bg-gray-100 dark:bg-gray-900 text-slate-800 dark:text-gray-200 antialiased overflow-hidden">
    <div x-data="{ 
        ...
        <div class="flex flex-col flex-1 min-w-0 overflow-hidden transition-all duration-300 lg:pl-[var(--sidebar-width)]"
            ...
            <main class="flex-1 overflow-y-auto scroll-smooth flex flex-col relative">
    ...
    <script>
        ...
        window.initPromiseDataTable = function(selector, options = {}) {
            const defaultOptions = {
                ...
                dom: '<"flex flex-col md:flex-row justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 gap-4"<"w-full md:w-auto"l><"w-full md:w-80"f>>rt<"flex flex-col md:flex-row justify-between items-center p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 gap-4"ip>',
                language: {
                    search: "",
