        ...
        <form id="form-complete" method="POST" enctype="multipart/form-data">
            ...
            <div class="px-6 py-5 space-y-4">
                ...
                <div>
                    ...
                    <input type="file" id="modal-photo-input" name="photo" required accept="image/*,application/pdf" capture="environment"
                    ...
                    <p class="text-[10px] text-gray-400 mt-1 italic">Max 30 MB (JPG/PNG/PDF). Choose file from gallery or take photo directly via camera.</p>
                </div>
                <div>
